...
2021-10-27T12:02:25.513 7 002 255 127258 : 00 f8 ff ff f6 07 ff ff
        ...
        public static void run()
        {
            ...
            Console.WriteLine("using System; using MissionPlanner.Utilities; using System.Collections.Generic;");

            Console.WriteLine(@"namespace NMEA2000
{
    public class NMEA2000msgs
    {
        private static readonly (int, Type)[] msgs = {
");
...
");
            ...
            foreach (var pgn in pgns.PgNs)
            {
                ...
                Console.WriteLine("public class " + pgn.Id + " { ");
...
");
    ...
    public class CANFrameNMEA
    {
        ...
        public CANFrameNMEA(byte[] packet_data)
        {
